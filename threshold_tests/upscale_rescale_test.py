...
def embed_images(
    image_path: str,
    method: str = "dwtDct",
    output_dir: str = "threshold_tests/512x512/upscale_test_results",
...
def decode_upscaled_images(
    input_root: str = "threshold_tests/512x512/upscale_test_results",
    methods: list[str] = ["dwtDct", "dwtDctSvd", "rivaGan"],
    watermark: str = "qingquan"
):
    for method in methods:
...
if __name__ == "__main__":
    ...
    batch_embed(
        ...
        output_dir="threshold_tests/512x512/upscale_test_results"
    )
    '''
